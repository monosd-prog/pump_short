            ...
            if entry_ok:
                ...
                try:
                    ...
                    sig = build_short_pump_signal(
                        ...
                        cvd_ratio_5m=entry_payload.get("cvd_ratio_5m"),
                        cvd_momentum=entry_payload.get("cvd_momentum"),
                        vp_poc_dist_pct=entry_payload.get("vp_poc_dist_pct"),
                        fp_imbalance_at_entry=entry_payload.get("fp_imbalance_at_entry"),
                        liq_short_usd_30s_real=entry_payload.get("liq_short_usd_30s_real"),
                        liq_long_usd_30s_real=entry_payload.get("liq_long_usd_30s_real"),
                        dist_to_peak_pct=dist_to_peak,
                        stage=st.stage,
